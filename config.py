...
UPSTREAM_REPO = getenv(
    "UPSTREAM_REPO",
    "https://github.com/istkharalam62/PurviMusic",
)
...
SUPPORT_CHANNEL = getenv("SUPPORT_CHANNEL", "https://t.me/Jani_Group")
SUPPORT_CHAT = getenv("SUPPORT_CHAT", "https://t.me/Jani_Group")
